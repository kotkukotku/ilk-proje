...
while True:
    try:
        ...
        timeout = float(input("Timeout'ı giriniz(Varsayılan 1): "))
        baslangic_port = int(input("Başlangıç portunu giriniz(minimum: 1):"))
        son_port = int(input("Bitiş portunu giriniz(maximum: 65535):"))
    except ValueError:
